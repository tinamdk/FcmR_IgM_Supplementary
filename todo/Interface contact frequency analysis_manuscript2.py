...
OUTPUT_DIR = "contact_analysis_outputs"
os.makedirs(OUTPUT_DIR, exist_ok=True)

COMMON_HEATMAP_PNG = os.path.join(OUTPUT_DIR, "Common_contacts_heatmap.png")
COMMON_HEATMAP_PDF = os.path.join(OUTPUT_DIR, "Common_contacts_heatmap.pdf")
PERSISTENCE_STACKED_PNG = os.path.join(OUTPUT_DIR, "Contact_persistence_stacked.png")
PERSISTENCE_STACKED_PDF = os.path.join(OUTPUT_DIR, "Contact_persistence_stacked.pdf")
GROUP_COMPARE_HEATMAP_PNG = os.path.join(OUTPUT_DIR, "FcμR_number_heatmap.png")
GROUP_COMPARE_HEATMAP_PDF = os.path.join(OUTPUT_DIR, "FcμR_number_heatmap.pdf")
FULL_HEATMAP_CSV = os.path.join(OUTPUT_DIR, "FcμR_number_heatmap_full.csv")   # 完整数据（补充材料）
THREE_GROUPS_BAR_PNG = os.path.join(OUTPUT_DIR, "Three_groups_barplot.png")
THREE_GROUPS_BAR_PDF = os.path.join(OUTPUT_DIR, "Three_groups_barplot.pdf")

PER_PDB_CSV = os.path.join(OUTPUT_DIR, "All_contact_proportions_per_PDB.csv")
DIFF_DIMER_VS_PENTAMER_CSV = os.path.join(OUTPUT_DIR, "Dimer_vs_Pentamer_diff.csv")
DIFF_SIGM_VS_PENTAMER_CSV = os.path.join(OUTPUT_DIR, "SIgM_vs_Pentamer_diff.csv")
DIFF_FCMUR_NUM_CSV = os.path.join(OUTPUT_DIR, "FcμR_number_comparison.csv")
THREE_GROUPS_CSV = os.path.join(OUTPUT_DIR, "Three_groups_comparison.csv")
...
def main():
    ...
    # -------------------------
    # 图1：共有残基对热图（加框，底色Reds）
    # -------------------------
    print("\n--- Figure 1: Common pairs heatmap ---")
    ...
    # -------------------------
    # 图4：不同FcμR数量的热图（只显示最大比例 > 0.8 的行，colorbar自适应高度）
    print("\n" + "=" * 60)
    print("Graph 3: Heatmap of contact proportions under different FcμR numbers (pentamer only)")
    print("(Only pairs with all proportions > 0.0 are shown, to exclude very low values)")
    print("=" * 60)
