...
Raw FoldX results for all seven complexes are in ../foldx_output/.
To reproduce the analysis, download FoldX 5.0 (https://foldxsuite.crg.eu) and run ../foldx_output/run_alanine_scan.bat.
