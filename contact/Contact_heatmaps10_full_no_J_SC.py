...
DIST_CUTOFF = 4.5
OUTPUT_PNG = "Extended Data Figure2.FcμR‑D1 contact occupancy per PDB structure.png"
OUTPUT_PDF = "Extended Data Figure2.FcμR‑D1 contact occupancy per PDB structure.pdf"
